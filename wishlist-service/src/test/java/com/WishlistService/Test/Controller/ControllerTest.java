package com.WishlistService.Test.Controller;
...
class ControllerTest {
	...
	void testAddNews() {
		...
		ResponseEntity<UserWishlist> responseEntity = wishlistController.addNews(wishlist);
...
//
//		ResponseEntity<String> responseEntity = wishlistController.removeNews(wishlistId, newsId);
//
